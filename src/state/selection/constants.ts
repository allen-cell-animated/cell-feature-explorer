...
export const REQUEST_CELL_FILE_INFO_BY_CELL_ID = makeSelectionConstant("REQUEST_CELL_FILE_INFO_BY_CELL_ID");
export const RECEIVE_FILE_INFO_FOR_HOVERED_CELL = makeSelectionConstant("RECEIVE_CELL_FILE_INFO_FOR_CELL");
