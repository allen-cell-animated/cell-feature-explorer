...
export const SET_SHOW_SMALL_SCREEN_WARNING = makeConstant("metadata", "set-show-small-screen-warning");
...
export const RECEIVE_MEASURED_FEATURE_DEFS = makeConstant("metadata", "receive-measured-feature-names");
